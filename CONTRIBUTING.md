...
- Add new technical indicators (ATR, OBV, Williams %R, Ichimoku...)
- Add more companies to `companies.json`
- Improve the signals scoring system
- Add new financial metrics (VaR, Sortino Ratio, Max Drawdown...)
- Improve PDF report design
- Add support for non-US markets (LSE, TSX, Tadawul...)
- Add portfolio optimization (Efficient Frontier, Min Variance)
- Improve sentiment analysis (FinBERT, broader news sources)
