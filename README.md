...
<div align="center">
  ...
  <p>
    <strong>Strategic Intelligence Report</strong><br/>
    <img src="docs/screenshots/screenshot_report.png" width="850" style="border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.5); border: 1px solid #30363d; margin-top: 10px;">
  </p>

  <br/>

  <p>
    <strong>Sentiment Analysis Flow</strong><br/>
    <img src="docs/screenshots/screenshot_sentiment.png" width="850" style="border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.5); border: 1px solid #30363d; margin-top: 10px;">
  </p>

  <br/>

  <p>
    <strong>Technical Market Visualization</strong><br/>
    <img src="docs/screenshots/screenshot_charts.png" width="850" style="border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.5); border: 1px solid #30363d; margin-top: 10px;">
  </p>

  <p>
    <sub><i>Visualized intelligence generated by MarketLab v3.1.0 — Powered by local data warehouse.</i></sub>
  </p>
</div>
