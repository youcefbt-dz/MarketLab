...
<div align="center" style="display: flex; justify-content: center; flex-wrap: wrap; gap: 15px;">
  ...
  <div style="flex: 1; min-width: 250px; max-width: 320px;">
    <p align="center"><strong>Strategic Report</strong></p>
    <img src="docs/screenshots/screenshot_report.png" style="width: 100%; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.5); border: 1px solid #30363d;">
  </div>

  <div style="flex: 1; min-width: 250px; max-width: 320px;">
    <p align="center"><strong>Sentiment Analysis</strong></p>
    <img src="docs/screenshots/screenshot_sentiment.png" style="width: 100%; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.5); border: 1px solid #30363d;">
  </div>

  <div style="flex: 1; min-width: 250px; max-width: 320px;">
    <p align="center"><strong>Technical Charts</strong></p>
    <img src="docs/screenshots/screenshot_charts.png" style="width: 100%; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.5); border: 1px solid #30363d;">
  </div>

</div>

<p align="center" style="margin-top: 20px;">
  <sub><i>Visual intelligence generated by MarketLab v3.1.0 — Powered by local data warehouse.</i></sub>
</p>
